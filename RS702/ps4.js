...
function setupRW() {
	...
	debug_log("Jailbreak Succesfully. Loading Payload ...");
...
function dumpTargetObj() {
	// debug_log( + g_timer_leak); 
	// debug_log( + g_message_heading_leak);
	// debug_log( + g_message_body_leak);
}
